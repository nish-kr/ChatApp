...
/**
 * Creating login service function to fetch the request from the user and pass it to the database.
 */
...
/**
 * Creating signup service function to fetch the request from the user and pass it to the database.
 */
